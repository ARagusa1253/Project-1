...
public boolean createTable() {
		...
		try(Connection conn = ConnectionUtil.getConnection()) {
			...
			for (MetaModel<?> metaModel : cfg.getMetaModels()) {
				String sql = "CREATE TABLE IF NOT EXISTS " + metaModel.getEntity(/*products*/) + " (\r\n"
					+ "			" + metaModel.getPrimaryKey().getColumnName(/*product_id*/) +  " SERIAL PRIMARY KEY\r\n"
					+ ");			";
			...
			logger.warn("Unable to create Product table in the DB");
			e.printStackTrace();
		}
